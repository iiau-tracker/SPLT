...
VID_root = '/media/masterbin-iiau/417507b2-6b1b-4e11-b488-4e0ff0e89a481/tangjiuqi097/ILSVRC2015_VID'
save_dir = '/home/masterbin-iiau/Object_Tracking/project_for_OT/MBMD_Bin/VID/type_video'
if __name__ == '__main__':
    VID_anno_root = os.path.join(VID_root,'ILSVRC2015/Annotations/VID/train')
    folders = ['a','b','c','d','e']
